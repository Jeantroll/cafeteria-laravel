                ...
                <div class="card card-profile shadow">
                    <div class="row justify-content-center">
                        <div class="col-lg-3 order-lg-2">
                            <div class="card-profile-image">
                                <a href="#">
                                    <img src="https://i.ibb.co/DkQXWhB/descarga-4.png" class="rounded-circle">
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body pt-0 pt-md-4">
                        ...
                        <div class="text-center">
                            ...
                            <div>
                                <i class="ni education_hat mr-2"></i>{{ __('') }}
                            </div>
                            <hr class="my-4" />
                            <p>{{ __('Ryan, el nombre adoptado por Nick Murphy, criado en Melbourne y radicado en Brooklyn, escribe, interpreta y graba toda su propia música.') }}</p>
                            <a href="#">{{ __('Mostrar más') }}</a>
                        </div>
                    </div>
                </div>
            </div>
