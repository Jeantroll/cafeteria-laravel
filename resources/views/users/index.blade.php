...
<div class="container-fluid">
    ...
    <a class="navbar-brand pt-0" href="{{ route('home') }}">
        <img src="https://i.ibb.co/25jsrZ9/descarga-3.png" class="navbar-brand-img" alt="...">
    </a>
    <!-- User -->
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('products') }}">
                    <i class="ni ni-planet text-blue"></i> {{ __('Productos') }}
                </a>
            </li>
            <li class="nav-item ">
                <a class="nav-link" href="{{ route('ventas') }}">
                    <i class="ni ni-pin-3 text-orange"></i> {{ __('Ventas') }}
                </a>
            </li>
        </ul>
        <!-- Divider -->
